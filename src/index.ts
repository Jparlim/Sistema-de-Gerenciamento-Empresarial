...
App.post("/config", (request: FastifyRequest, reply: FastifyReply) =>
  ChosenClient(request, reply, App),
);

App.put("/config-update", (request: FastifyRequest, reply: FastifyReply) =>
  UpdateConfigIA(request, reply, App),
);

App.delete("/config-delete", (request: FastifyRequest, reply: FastifyReply) =>
  UpdateConfigIA(request, reply, App),
);
...
App.post("/create", (request: FastifyRequest, reply: FastifyReply) =>
  CriaConta(request, reply, App),
);

App.post("/login", (request: FastifyRequest, reply: FastifyReply) =>
  Login(request, reply, App),
);

App.post("/verify-token", (request: FastifyRequest, reply: FastifyReply) =>
  Token(request, reply, App),
);
